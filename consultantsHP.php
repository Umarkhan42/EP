...
<body>
    <div class="container">
        ...
        <section class="todo">
            ...
            <form action="addToDoConsultants.php" method="POST">
                <div>
            ...
            <?php
            include "config.php";
            $rawData = mysqli_query($con, "select * from todoconsultants");
            ?>
                ...
                <div class="deskSupport-content">
                    ...
                    <form id="contactForm">
                        <div>
                            ...
                            <input type="text" placeholder="Your Name" id="username" name="username"> <!-- Updated placeholder for clarity -->
                        </div>
                        <div>
